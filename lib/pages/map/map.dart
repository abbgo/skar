...
import 'package:skar/pages/errors/internet_error.dart';
...
class MapPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    var internetStatus = ref.watch(intConnStatusProvider);

    return Scaffold(
      body: internetStatus == ConnectivityStatus.isConnected
          ? isLoading
              ? Center(
